          ...
          >
            ...
            >
              ...
              <span className="text-[11px] font-mono uppercase tracking-widest text-lime-400 font-bold">
                {heroContent?.badge || FALLBACK_BADGE}
              </span>
            </motion.div>
            ...
            >
              {heroContent?.subtitle || FALLBACK_SUBTITLE}
            </p>
            ...
            >
              ...
              >
                <span>{heroContent?.primary_cta_text || FALLBACK_PRIMARY_CTA}</span>
              ...
              >
                <span>{heroContent?.secondary_cta_text || FALLBACK_SECONDARY_CTA}</span>
              </button>
            </motion.div>
